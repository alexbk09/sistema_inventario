    ...
    <AuthenticatedLayout>
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-foreground mb-2">Nueva Transferencia</h1>
            <p className="text-muted-foreground">Mueve stock entre sucursales o bodegas.</p>
          </div>
        </div>
        ...
        <form onSubmit={submit} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-card border border-border rounded-lg p-6 space-y-4">
              <h2 className="text-lg font-bold text-foreground">Datos de la transferencia</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-semibold text-foreground mb-1">Sucursal origen</label>
                  <select
                ...
                <div>
                  <label className="block text-sm font-semibold text-foreground mb-1">Sucursal destino</label>
                  <select
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2 bg-background border border-border rounded-lg text-sm text-foreground"
                  rows={2}
                  placeholder="Detalle adicional de la transferencia"
                />
              </div>
            </div>
            ...
            <div className="bg-card border border-border rounded-lg p-6 space-y-4">
              ...
              <div className="mt-4">
                <h3 className="text-sm font-semibold text-foreground mb-2">Ítems de la transferencia</h3>
          ...
          <div className="lg:col-span-1">
            <div className="bg-card border border-border rounded-lg p-6 space-y-3 sticky top-20 h-fit">
              ...
              <p className="text-sm text-muted-foreground">
                La transferencia se creará en estado <span className="font-semibold text-foreground">borrador</span>. Luego
                podrás marcarla como completada cuando el movimiento físico se haya realizado.
              </p>
